...
AccelerometerTrusted_node1684356611350 = glueContext.write_dynamic_frame.from_options(
    frame=DropFields_node1684356749419,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://geekwho/accelerometer/trusted/",
        "partitionKeys": [],
    },
    transformation_ctx="AccelerometerTrusted_node1684356611350",
)
